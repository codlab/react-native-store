...
var Filter = /** @class */ (function () {
    ...
    Filter.prototype.apply = function (set, settings) {
    ...
    Filter.prototype.evaluate = function (filter, element) {
    ...
    Filter.prototype.evaluateLogicalOperator = function (operator, filter, element) {
        if (operator == 'and') {
            for (var i in filter) {
                var comp = filter[i];
                if (!this.evaluate(comp, element))
                    return false;
            }
            return true;
        }
    ...
    Filter.prototype.evaluateComparisonOperator = function (operator, filter, element) {
        if (operator == 'neq')
    ...
    Filter.prototype.applyFieldsFilter = function (element, fields) {
